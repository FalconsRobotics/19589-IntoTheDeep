...
public class MeepMeepSpecimenAuto {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(35, 35, Math.toRadians(180), Math.toRadians(180), 18.46)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(startPos)
                        ...
                        .splineToLinearHeading(new Pose2d(43, -63.625, Math.toRadians(0)), Math.toRadians(270))
                        .lineToLinearHeading(new Pose2d(-1, -30, Math.toRadians(180)))

                        .splineToLinearHeading(new Pose2d(60, -63.625, Math.toRadians(180)), Math.toRadians(270))
                        .lineToLinearHeading(new Pose2d(1, -30, Math.toRadians(0)))

                        .splineToLinearHeading(new Pose2d(43, -63.625, Math.toRadians(0)), Math.toRadians(270))
                        .lineToLinearHeading(new Pose2d(-1, -30, Math.toRadians(180)))

                        .splineToLinearHeading(new Pose2d(60, -63.625, Math.toRadians(180)), Math.toRadians(-90))
