package org.firstinspires.ftc.teamcode.external.rrquickstart.util;
...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = MecanumDriveKinematics.TRANSLATIONAL_PID.kP;
        public double mecTransI = MecanumDriveKinematics.TRANSLATIONAL_PID.kI;
        public double mecTransD = MecanumDriveKinematics.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = MecanumDriveKinematics.HEADING_PID.kP;
        public double mecHeadingI = MecanumDriveKinematics.HEADING_PID.kI;
        public double mecHeadingD = MecanumDriveKinematics.HEADING_PID.kD;
        public double mecLateralMultiplier = MecanumDriveKinematics.LATERAL_MULTIPLIER;
